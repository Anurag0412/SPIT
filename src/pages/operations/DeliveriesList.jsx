    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          <p className="text-gray-400">Manage outgoing inventory</p>
        </motion.div>
              ...
              <table className="w-full">
                ...
                <tbody>
                  {filteredDeliveries.map((delivery, index) => (
                    ...
                    >
                      <td className="px-6 py-4 text-white font-medium">{delivery.reference}</td>
                      <td className="px-6 py-4 text-gray-300">{delivery.from}</td>
                      <td className="px-6 py-4 text-gray-300">{delivery.to}</td>
                      <td className="px-6 py-4 text-gray-300">{delivery.contact}</td>
                      <td className="px-6 py-4 text-gray-300">{delivery.scheduleDate}</td>
